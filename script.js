...
const T = {
  en: {
    ...
    heroLead: "Focused on Agent Runtime, Agent Workflow, Tool Calling, Streaming UX, personalization, and Text2SQL systems that can be measured, tested, and shipped.",
    heroAsk: "Ask the resume agent",
    heroWork: "View selected work",
    consoleLine1: "Profile loaded: Agent Runtime, Agent Workflow, Streaming, Tool Calling, Personalization, Text2SQL.",
    ...
    cap4: "Natural-language data access for enterprise users: multi-stage agent workflows, dual-layer vector reranking, SQL validation, and 1,000+ case eval suites.",
  ...
  zh: {
    ...
    heroLead: "专注 Agent Runtime、Agent Workflow、Tool Calling、Streaming 体验、个性化推荐和 Text2SQL 系统，强调可度量、可测试、可上线。",
    heroAsk: "询问简历 Agent",
    heroWork: "查看项目",
    consoleLine1: "Profile loaded: Agent Runtime, Agent Workflow, Streaming, Tool Calling, Personalization, Text2SQL.",
    ...
    cap4: "为企业用户构建自然语言数据访问能力：多阶段 Agent 工作流、双层向量 Rerank、SQL 校验与 1000+ 条用例评估体系。",
