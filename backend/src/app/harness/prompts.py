...
def _base_rules(language: Language, has_history: bool = False) -> str:
    ...
    return (
        ...
        "For questions that ask for a complete set (all degrees, all employers, full tech stack, all skills), enumerate every item from the evidence — completeness matters more than brevity. "
        "Do not dump unrelated projects unprompted. "
