...
def _base_rules(language: Language, has_history: bool = False) -> str:
    ...
    return (
        ...
        "When asked about a specific skill or project, focus on the single most relevant evidence — do not dump all projects unprompted. "
        "When the question explicitly asks for a complete set (e.g. all degrees, all companies, all skills), enumerate every item from the evidence. "
